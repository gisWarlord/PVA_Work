...
extraTable = arcpy.GetParameterAsText(2)            # optional input

extraParcelId = arcpy.GetParameterAsText(3)         # optional input
...
routes = arcpy.GetParameterAsText(5)
...
try:
    ...
    if arcpy.Exists(outShp):
        ...
        ScriptUtils.AddMsgAndPrint("\tAdding {0} to the MXD...".format(routesLayer), 0)
